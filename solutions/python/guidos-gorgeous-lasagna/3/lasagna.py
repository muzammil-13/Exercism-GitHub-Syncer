"""Module for calculating lasagna bake times.

This module provides functions to calculate the expected bake time for lasagna,
the remaining bake time, and the total elapsed time including preparation.
"""
...
def preparation_time_in_minutes(number_of_layers):
    ...
    the total preparation time based on a predefined `PREPARATION_TIME`
    per layer.
